...
import { GetAllFieldsByContextViewModel } from '@/modules/fields/application/queries/get-all-fields-by-context/get-all-fields-by-context.viewmodel';
...
export class GetAllFieldsByContextController extends HttpControllerBase {
  ...
  async createField(@Tenant() tenant: TenantContext, @Param('context') context: string) {
